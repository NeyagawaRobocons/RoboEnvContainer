...
{
  new (message_memory) nucleo_agent::msg::SensorStates(_init);
}

void SensorStates_fini_function(void * message_memory)
{
  auto typed_message = static_cast<nucleo_agent::msg::SensorStates *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SensorStates_message_member_array[2] = {
  {
    ...
    offsetof(nucleo_agent::msg::SensorStates, potentiometer_angles),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nucleo_agent::msg::SensorStates, limit_switch_states),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SensorStates_message_members = {
  ...
  2,  // number of fields
  sizeof(nucleo_agent::msg::SensorStates),
...
{
  return &::nucleo_agent::msg::rosidl_typesupport_introspection_cpp::SensorStates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nucleo_agent, msg, SensorStates)() {
  return &::nucleo_agent::msg::rosidl_typesupport_introspection_cpp::SensorStates_message_type_support_handle;
}
