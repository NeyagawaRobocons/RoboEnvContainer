...
: ${AMENT_CURRENT_PREFIX:="/ROS_ws/install/pure_pursuit"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pure_pursuit/environment/library_path.sh"
