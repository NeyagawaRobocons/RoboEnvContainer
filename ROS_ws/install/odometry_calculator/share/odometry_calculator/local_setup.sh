...
: ${AMENT_CURRENT_PREFIX:="/ROS_ws/install/odometry_calculator"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/odometry_calculator/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/odometry_calculator/environment/path.sh"
