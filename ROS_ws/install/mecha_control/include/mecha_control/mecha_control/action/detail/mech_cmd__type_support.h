...
#ifndef MECHA_CONTROL__ACTION__DETAIL__MECH_CMD__TYPE_SUPPORT_H_
#define MECHA_CONTROL__ACTION__DETAIL__MECH_CMD__TYPE_SUPPORT_H_
...
#endif  // MECHA_CONTROL__ACTION__DETAIL__MECH_CMD__TYPE_SUPPORT_H_
