...
#ifndef MECHA_CONTROL__MSG__DETAIL__ACTUATOR_COMMANDS__FUNCTIONS_H_
#define MECHA_CONTROL__MSG__DETAIL__ACTUATOR_COMMANDS__FUNCTIONS_H_
 ...
 * calls
 * mecha_control__msg__ActuatorCommands__init().
...
/**
 * It calls
 * mecha_control__msg__ActuatorCommands__fini()
 ...
 * mecha_control__msg__ActuatorCommands__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mecha_control__msg__ActuatorCommands__Sequence__fini()
 * on the array,
...
#endif  // MECHA_CONTROL__MSG__DETAIL__ACTUATOR_COMMANDS__FUNCTIONS_H_
