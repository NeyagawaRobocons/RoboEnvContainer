...
{
  new (message_memory) mecha_control::msg::ActuatorCommands(_init);
}

void ActuatorCommands_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mecha_control::msg::ActuatorCommands *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ActuatorCommands_message_member_array[2] = {
  {
    ...
    offsetof(mecha_control::msg::ActuatorCommands, motor_positions),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mecha_control::msg::ActuatorCommands, cylinder_states),  // bytes offset in struct
    nullptr,  // default value
...
{
  return &::mecha_control::msg::rosidl_typesupport_introspection_cpp::ActuatorCommands_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mecha_control, msg, ActuatorCommands)() {
  return &::mecha_control::msg::rosidl_typesupport_introspection_cpp::ActuatorCommands_message_type_support_handle;
}
