...
static const _ActuatorCommands_type_support_symbol_names_t _ActuatorCommands_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nucleo_agent, msg, ActuatorCommands)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nucleo_agent, msg, ActuatorCommands)),
  }
};
...
{
  return &::nucleo_agent::msg::rosidl_typesupport_cpp::ActuatorCommands_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, nucleo_agent, msg, ActuatorCommands)() {
  return get_message_type_support_handle<nucleo_agent::msg::ActuatorCommands>();
}
