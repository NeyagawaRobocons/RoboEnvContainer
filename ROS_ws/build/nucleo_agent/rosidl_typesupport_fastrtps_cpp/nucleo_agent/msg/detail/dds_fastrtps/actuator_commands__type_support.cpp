...
#include "nucleo_agent/msg/detail/actuator_commands__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const nucleo_agent::msg::ActuatorCommands *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nucleo_agent::msg::ActuatorCommands *>(
    untyped_ros_message);
...
{
  return &nucleo_agent::msg::typesupport_fastrtps_cpp::_ActuatorCommands__handle;
}
