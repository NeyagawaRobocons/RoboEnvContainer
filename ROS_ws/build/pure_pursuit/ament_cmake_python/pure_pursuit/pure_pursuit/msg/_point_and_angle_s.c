...
bool pure_pursuit__msg__point_and_angle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pure_pursuit.msg._point_and_angle.PointAndAngle", full_classname_dest, 47) == 0);
  }
  pure_pursuit__msg__PointAndAngle * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of PointAndAngle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("pure_pursuit.msg._point_and_angle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PointAndAngle");
