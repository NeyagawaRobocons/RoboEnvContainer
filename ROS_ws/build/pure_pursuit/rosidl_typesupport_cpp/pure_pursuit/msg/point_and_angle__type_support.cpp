...
static const _PointAndAngle_type_support_symbol_names_t _PointAndAngle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pure_pursuit, msg, PointAndAngle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pure_pursuit, msg, PointAndAngle)),
  }
};
...
{
  return &::pure_pursuit::msg::rosidl_typesupport_cpp::PointAndAngle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pure_pursuit, msg, PointAndAngle)() {
  return get_message_type_support_handle<pure_pursuit::msg::PointAndAngle>();
}
