...
static const _ActuatorCommands_type_support_symbol_names_t _ActuatorCommands_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mecha_control, msg, ActuatorCommands)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mecha_control, msg, ActuatorCommands)),
  }
};
...
{
  return &::mecha_control::msg::rosidl_typesupport_cpp::ActuatorCommands_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mecha_control, msg, ActuatorCommands)() {
  return get_message_type_support_handle<mecha_control::msg::ActuatorCommands>();
}
