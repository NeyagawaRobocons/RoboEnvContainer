...
static const _PointAndMechaStateArray_type_support_symbol_names_t _PointAndMechaStateArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mecha_control, msg, PointAndMechaStateArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mecha_control, msg, PointAndMechaStateArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mecha_control, msg, PointAndMechaStateArray)() {
  return &::mecha_control::msg::rosidl_typesupport_c::PointAndMechaStateArray_message_type_support_handle;
}
